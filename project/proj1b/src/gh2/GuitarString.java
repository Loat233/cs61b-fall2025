...
public class GuitarString {
    ...
    public GuitarString(double frequency) {
        ...
        buffer.resizing((int) capacity);
        for (int i = 0; i < capacity; i++) {
            buffer.addLast(0.0);
        }
        System.out.println("resizing Finish");
    }
    ...
    public void pluck() {
        ...
        for (int i = 0; i < buffer.size(); i++) {
            buffer.replace(i, Math.random() - 0.5);
        }
    ...
    public void tic() {
        ...
        ftSample = buffer.get(0);
        nxSample = buffer.get(1);
        nwSample = DECAY * (ftSample + nxSample) * 0.5;

        buffer.removeFirst();
        buffer.addLast(nwSample);
    }
